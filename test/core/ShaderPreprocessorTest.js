...
const ShaderPreprocessor = require('../../src/core/ShaderPreprocessor');
	...
	describe('#preprocess', () => {
		it('should correctly substitute `#define` statements', () => {
			const source = `
				...
				TEST_2
			`;
			const evaluated = ShaderPreprocessor.preprocess(source).split('\n');
		...
		it('should support case insensitive ShaderPreprocessor.preprocessor syntax', () => {
			const source = `
				#DEFINE TEST 0
				#IFDEF test
					0
